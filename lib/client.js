...
`;
		...
		function BranchSelector({ git }) {
			...
			useEffect(() => {
				...
				const onKey = (e) => { if (e.key === "Escape") { e.stopPropagation(); setBranchOpen(false); setBranchSel(null); setBranchInput(null); setBranchQuery(""); } };
			...
			const runBranchAction = async (fn) => {
				setBranchOpen(false); setBranchSel(null); setBranchInput(null); setBranchQuery("");
				await fn();
			};
			...
			return h("div", { className: "dgp-branchTab", "data-open": branchOpen ? "true" : "false" },
				...
				branchOpen && branchPos ? ReactDOM.createPortal(h("div", { className: "dgp-branchPop", style: { left: branchPos.left, top: branchPos.top }, onClick: (e) => e.stopPropagation() },
					...
					branchActions,
					h("div", { className: "dgp-branchPopFoot" }, lbtn(t("common.close"), () => { setBranchOpen(false); setBranchSel(null); setBranchQuery(""); }))
				), document.querySelector(".dgp-root")) : null
			);
		}
