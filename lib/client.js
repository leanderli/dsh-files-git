...
.dgp-logRow{flex-direction:column;align-items:stretch;gap:1px;padding-top:5px;padding-bottom:5px}
			...
			return h(React.Fragment, null,
				h("div", { className: "dgp-gitCard dgp-histCard", ref: histRef },
					...
					h("div", { className: "dgp-gitScroll dgp-histList" }, entries.slice(0, logLimit).map((e) => {
						...
						return h("div", {
							key: `log:${e.hash ?? hash}`, className: "dgp-row dgp-logRow", "data-clickable": "true",
			...
			const previewView = () => {
				...
				if (pvEdit) {
					...
					body = pvCmErr
						...
						: h("div", { className: "dgp-editorHost", ref: pvCmHostRef }, pvCmBusy ? h("div", { className: "dgp-paneEmpty" }, t("pv.loadingEditor")) : null);
				} else {
